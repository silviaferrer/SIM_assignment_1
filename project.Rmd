...
train2$f.LotArea<- factor(train2$f.LotArea, labels=c("LowQual","MidQual","HighQual"), order = T, levels=c(1,2,3))
...
----From the summary, it can be observed that the change mostly affected the coefficients of ?????. 
The R-squared of the model has increased up to 0.95.
