...
Therefore we have 2 potential models. We have been looking on the accuracy of the model,  currently on 90% (will deppend on the seed), but we need to check if there is overfitting using the test sample. 
