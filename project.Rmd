...
qqnorm(imputed_data$SalePrice)
qqline(imputed_data$SalePrice)
hist(imputed_data$SalePrice, prob = TRUE, col = 'lightblue', main = 'SalePrice Distribution', xlab = 'SalePrice')
lines(density(imputed_data$SalePrice), col = 'red', lwd = 2)
